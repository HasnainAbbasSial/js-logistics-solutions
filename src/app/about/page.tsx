    ...
    return (
        <div className="flex flex-col">
            <PageHeader
                ...
                description="JS Logistics Solutions was founded with a single mission: to provide owner-operators and small fleets with the professional logistical support they need to compete with industry giants."
            />
                        ...
                        >
                            <div>
                                ...
                                <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
                                    <p>
                                        We started as a dedicated team with deep roots in logistics and transportation. We recognized the daily challenges independent drivers face—balancing the open road with complex administrative demands.
                                    </p>
                                    <p>
                                        JS Logistics Solutions was created to be more than a service provider; we are your strategic partner. We don't just book loads; we optimize your entire business cycle.
                                    </p>
                                </div>
                            </div>
