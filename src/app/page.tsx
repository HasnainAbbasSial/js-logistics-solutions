        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-white leading-tight mb-6">
              Maximize Your Miles with <span className="text-primary">JS Logistics</span>
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 relative">
              <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Professional JS Logistics Truck"
                  width={800}
                  height={600}
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-8">Why Professional Carriers Choose <span className="text-primary">JS Logistics</span></h2>
