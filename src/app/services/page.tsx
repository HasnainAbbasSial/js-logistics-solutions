                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="lg:w-1/2 border-l-4 border-white/20 pl-12">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-primary font-bold">JS</div>
                                <div>
                                    <p className="font-bold">Operations Team</p>
                                    <p className="text-white/60 text-sm">JS Logistics Solutions</p>
                                </div>
                            </div>
                        </div>
                    </div>
