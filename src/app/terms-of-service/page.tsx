                ...
                <div className="bg-white dark:bg-secondary/40 rounded-[2.5rem] p-8 md:p-12 shadow-xl border border-gray-100 dark:border-gray-800 space-y-8 text-gray-700 dark:text-gray-300">
                    <section>
                        ...
                        <p className="leading-relaxed">
                            By accessing or using the services provided by JS Logistics Solutions ("we," "us," or "our"), you agree to be bound by these Terms of Service. If you do not agree to these terms, you may not use our services.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="leading-relaxed">
                            JS Logistics Solutions provides professional truck dispatching services, including load matching, broker credit checks, administrative support, and route optimization. We act as an agent for the carrier to secure freight and streamline logistics operations.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="leading-relaxed">
                            JS Logistics Solutions is not responsible for any delays, damage to cargo, or disputes between the carrier and the broker/shipper. Our liability is limited specifically to the dispatching services provided.
                        </p>
                    </section>
